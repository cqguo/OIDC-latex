...
The login process of UPPRESSO adopts the communication pattern of OpenID Connect, a widely deployed SSO system.
  %  and $PID_{RP}$ is .
...
The analysis demonstrates that UPPRESSO protects user privacy well, without any degradation on the security of OpenID Connect.
