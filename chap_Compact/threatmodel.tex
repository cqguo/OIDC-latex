...
Therefore, the privacy leakage due to user re-identification by distinctive attributes is out of the scope of our work.
...
Such attacks shall be prevented by other exiting defenses.
