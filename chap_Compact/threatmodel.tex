...
Then,
    we introduce identity-transformation functions satisfying the requirements,
...
a malicious RP might manipulate $PID_{RP}$ in a login instance,
    attempting to allure honest users to return an identity token which might be accepted by some honest RP;
