...
In this section,
    we describe the threat model and assumptions of these components in UPPRESSO.
...
The malicious users and RPs may collude and behave arbitrarily, attempting to break the security of UPPRESSO.
For example,
