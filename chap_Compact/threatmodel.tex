...
This section presents the threat model of UPPRESSO,
...
First of all,
    we assume that a user never authorizes the IdP to enclose any \emph{distinctive attributes} in identity tokens,
        where distinctive attributes are identifiable information such as telephone number, Email, driver license, etc.
...
Such network attacks shall be prevented by other existing defenses.
