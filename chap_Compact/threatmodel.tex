...
For example, the curious IdP may store all messages received and sent,
    and tries to conduct attacks of visit tracing or identity linkage
...
We prevent the IdP-based visit tracing based on the SSO protocols,
    and we do not consider other network attacks (e.g., the network traffic analysis to correlate a user's logins at different RPs).
