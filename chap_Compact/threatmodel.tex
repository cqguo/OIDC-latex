...
Then,
    we design three identity-transformation functions satisfying the requirements,
...
Therefore, the privacy leakage due to user re-identification by distinctive attributes,
...
Such attacks shall be prevented by other network defenses.
