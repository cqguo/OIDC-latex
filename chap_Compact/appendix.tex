...
An SSO system is secure {\em iff} for any honest RP, it would derive the constant identity from an accepted token, while the identity must belong to the user or the collusive participators.  
