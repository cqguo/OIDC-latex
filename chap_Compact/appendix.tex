...
\label{ape:model}
In this section,
we  formally analyze  the security properties of UPPRESSO based on the Dolev-Yao style web model~\cite{SPRESSO}.
...
Following, we present the model of UPPRESSO system, containing normal data and each entities (including browser, servers, and scripts).
...
\subsection{How to Model the Web System}
...
\subsection{Modelled UPPRESSO System}
...
In the web system, it can represent the how the entities, such as the server, deal with the received messages, and send message to other entities.
In this section, we provide the detailed relations of the processes (including atomic process and script process) in UPPRESSO system.
