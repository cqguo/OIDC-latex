...
\textbf{If only it can be proved that the adversary cannot take any advantage on guessing whether $PID_U$s belong to same $ID_U$, RP-based identity linkage should be considered impossible in UPPRESSO.}
