...
Although the path part of $Enpt_{RP}$, e.g., \verb+/uploadTkn+,
...
If two RPs run on one domain but with different endpoints to receive identity tokens
        (e.g., \verb+https://RP.com/honest/uploadTkn+ and \verb+https://RP.com/malicious/uploadTkn+),
         they cannot be distinguished by scripts and \verb+postMessage+.
...
So
    a (malicious) RP could access the other's resources in the browser,
        e.g., steal  cookies
        by scripts
