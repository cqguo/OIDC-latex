...
This binding may be finished in another way:
    $ID_{RP}$ is deterministically calculated based on the RP's domain (e.g.,
...
On the other hand, once the RP updates its domain, for example, from \verb+https://www.theRPdomain.com/+ to \verb+https://www.RPdomain.com/+,
