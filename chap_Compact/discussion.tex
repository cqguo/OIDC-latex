...
When a user logins multiple RPs concurrently on one device as different accounts,
...
However, this active attack does not appear only in SSO systems, but also exists in all web applications with accounts.
Anyway,
    this attack can be easily prevented through various methods,
