...
This risk resuts from the SOP design of browsers.
...
To protect RP identities from the IdP,
        privacy-preserving access tokens (e.g., ring or group signatures \cite{ring-sig,chaum1991group}, and TrustToken \cite{trusttoken})
