...
After authenticating the user,
    the trusted third party (TTP) issues a certified short-term anonymous credential, also kept on the user's device.
Once attempting to login to any RP,
    the user proves that he is the owner of this secret and credential to the RP without exposing the secret;
...
TTP-certified anonymous credentials protect user privacy \cite{ZhangKSZR21,IsaakidisHD16} and enable the visits to multiple RPs,
