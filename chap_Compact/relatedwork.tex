...
TTP-certified anonymous credentials protect user privacy \cite{ZhangKSZR21,IsaakidisHD16} well, %and enable the visits to multiple RPs,
    but the user has to by himself manage user attributes and the accounts at different RPs.
...
On the contrary,
    ...
    as authentication happens between a user and the IdP (and an RP verifies tokens only).
