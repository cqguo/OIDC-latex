...
The sharing of random numbers enables the derivation of permanent accounts,
 while the additional unlinkability across colluding RPs is supported. Their knowledge about two different users $u$ and $u'$, i.e., ($ID_{RP}, t, [u]ID_{RP}$) and ($ID_{RP'}, t', [u']ID_{RP'}$), obtained from different logins, are indistinguishable.
