...
An authentication flaw found in Google Apps~\cite{ArmandoCCCPS13}, allowed a malicious RP to hijack a user's authentication attempt and inject the malicious code to steal the cookie (or identity proof) for the targeted RP, breaking the confidentiality.
...
The integrity has been tampered with in SAML, OAuth and OIDC systems ~\cite{SomorovskyMSKJ12,WangCW12,ZhouE14,WangZLG16,YangLLZH16,MainkaMS16, MainkaMSW17},
 due to various vulnerabilities, such as  XML Signature wrapping (XSW)~\cite{SomorovskyMSKJ12}, RP's incomplete verification~\cite{WangCW12,ZhouE14,WangZLG16,YangLLZH16} and etc.
