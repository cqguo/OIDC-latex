...
However, if we use these tokens to realize an SSO service, the RPs cannot identify each user, because these tokens are completely indistinguishable.

\usso\ applies a similar cryptographic skill to design identity transformations. % (see details in Section \ref{sec:UPPRESSO}).
