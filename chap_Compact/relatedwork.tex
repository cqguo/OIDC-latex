...
A user of EL PASSO \cite{ZhangKSZR21}
    keeps a permanent secret on his device.
...
even if a credential is used for multiple RPs,
    this randomized anonymous credential \cite{anon-credential} prevents collusive RPs from linking the login instances.
UnlimitID \cite{IsaakidisHD16} presents similar designs.
TTP-certified anonymous credentials protect user privacy \cite{ZhangKSZR21,IsaakidisHD16} well, %and enable the visits to multiple RPs,
