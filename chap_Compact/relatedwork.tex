...
After authenticating the user,
    the trusted third party (TTP) issues a certified long-term credential, also kept on the user's device.
...
even if a credential is used for multiple RPs,
    this randomized anonymous credential \cite{anon-credential} prevents collusive RPs from linking these login instances.
