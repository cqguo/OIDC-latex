...
SAML-based SSO is also formally analyzed \cite{ArmandoCCCT08},
    and the RP identity is found not to be bound correctly in the identity tokens of a variant designed by Google.
...
An extension, named single sign-off, is proposed for OIDC.
Single sign-off  allows the user to revoke all her identity tokens and notify all RPs to freeze her accounts \cite{GhasemisharifRC18}.
The design of single sign-off can also be achieved in UPPRESSO,
