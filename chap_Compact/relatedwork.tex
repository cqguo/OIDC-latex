...
Anonymous SSO systems was proposed for the global system for mobile (GSM) communications \cite{ElmuftiWRR08},
...
scheme, etc.,
     were adopted to design anonymous SSO schemes \cite{WangWS13,HanCSTW18,Lee18,HanCSTWW20}.
...
The single sign-off could also be achieved in UPPRESSO, where the user needs to revoke the identity tokens at all RPs, as the IdP doesn't know which RPs the user visits.
