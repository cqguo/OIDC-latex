...
due to software vulnerabilities, such as XML signature wrapping (XSW) \cite{SomorovskyMSKJ12}, incomplete verification by RPs \cite{WangCW12,WangZLG16,MainkaMSW17}, and IdP spoofing \cite{MainkaMS16,MainkaMSW17}.
...
Automatical tools, such as SSOScan \cite{ZhouE14}, OAuthTester \cite{YangLLZH16} and S3KVetter \cite{YangLCZ18},
 are designed to detect violations of the confidentiality, integrity, or RP designation in identity tokens.
