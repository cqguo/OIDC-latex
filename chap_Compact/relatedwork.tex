...
\vspace{1mm}
\noindent\textbf{Certified Anonymous Credentials.}
...
even if a credential is used for multiple RPs,
    this anonymous credential \cite{anon-credential} prevents collusive RPs from linking the login instances.
UnlimitID \cite{IsaakidisHD16} presents similar designs.
TTP-certified anonymous credentials protect user privacy well \cite{ZhangKSZR21,IsaakidisHD16}, %and enable the visits to multiple RPs,
