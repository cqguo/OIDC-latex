...
In EL PASSO, UnlimitID or FIDO,
    a user needs to notify each RP when a credential or FIDO device is lost or compromised,
because the user is authenticated actually by the RP with certified credentials.
On the contrary,
