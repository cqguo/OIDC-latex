...
Last but not least, \usso\ requires an additional property in SSO services, called \emph{RP designation},
 and it is ensured only if no collision exists in RPs' pseudo-identities (see Lemma 1), which are actually the blinded inputs of the pseudo-random function.
