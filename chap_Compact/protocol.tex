...
UPPRESSO works with commercial-off-the-shelf (COTS) browsers as the SSO user agent. %by the following designs.
...
and signs $[PID_{RP}, PID_U, Issuer, Validity, Attr]_{SK}$,
 where $Issuer$ is the IdP's identity, $Validity$ indicates the validity period, and $Attr$ contains the requested user attributes.
