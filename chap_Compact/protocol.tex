...
On receiving an identity-token request for $PID_{RP}$ from a user with $ID_U$, the IdP calculates $PID_{U}$.
\begin{equation}
...
\begin{figure*}[htb]
  \centering
  \includegraphics[height=0.572\textheight]{fig/process-js.pdf}
