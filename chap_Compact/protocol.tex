...
The malicious user could repeat the above attacks with random $u \in \mathbb{Z}_n$,
     until the account of some target victim user is calculated by the RP.\footnote{If it does not derive an existing account of some honest user,
      the RP will deal with the adversary as a newly-registered user without any alerts.}
