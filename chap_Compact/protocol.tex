...
\newc
Meanwhile, a user's identity $u$ is kept secret from RPs. Otherwise, colluding RPs could calculate $[u]ID_{RP_j}$ for the known $u$s and link them.
