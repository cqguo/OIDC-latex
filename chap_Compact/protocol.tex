...
\item [3.3]
The IdP script locally obtains the user's authorization to enclose each requested attribute,
...
and signs $[PID_{RP}, PID_U, Issuer, Validity, Attr]_{SK}$,
 where $Issuer$ is the IdP's identity, $Validity$ indicates the validity period, and $Attr$ contains the user attributes.
