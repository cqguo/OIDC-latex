...
From Equations \ref{equ:PIDRP}, \ref{equ:PIDU} and \ref{equ:Account}, we obtain
...
So the RP obtains the identical permanent account from different tokens in multiple login instances.
Moreover, 
