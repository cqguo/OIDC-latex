...
\begin{figure*}
  \centering
  \includegraphics[width=0.65\textwidth]{fig/process-js.pdf}
...
and these designs enable UPPRESSO to provide SSO services for web users with standard browsers.
More efficient but less portable implementations with browser extensions and/or plug-ins are discussed in Section \ref{sec:discussion}.
