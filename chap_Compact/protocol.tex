...
\begin{figure*}
  \centering
  \includegraphics[width=0.64\textwidth]{fig/process-js.pdf}
...
We design three identity-transformation functions,
    ...
    over an elliptic curve $\mathbb{E}$,
     where $G$ is the base point of this curve and the order of $G$ is a prime number denoted as $n$.        %the NIST elliptic curve $P$-256,
