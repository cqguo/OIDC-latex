...
\begin{figure*}[!t]
  \centering
  \includegraphics[height=0.84\textheight]{fig/process-js.pdf}
...
It is conducted by the IdP script in the browser. %Otherwise, the IdP can associate $PID_{RP}$ and $ID_{RP}$.
\begin{itemize}
%\setlength{\itemsep}{0pt plus 1pt}
\vspace{-\topsep}
