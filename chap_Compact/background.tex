...
\footnotesize
  ...
  & User Identity & User Authentication to & IdP-Confirmed Selective  & IdP-based & RP-based & Collusive Attack \\
  & at an RP & Only the IdP &  Attribute Provision & Login Tracing & Identity Linkage & by the IdP and RPs \\\hline\hline
  ...
  SPRESSO \cite{SPRESSO} & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$$^2$ & $\CIRCLE$ & $\Circle$ & - \\ \hline  \hline
...
Three features are expected in SSO services, which are supported by popular SSO systems \cite{NIST2017draft,OpenIDConnect,rfc6749,SAML,SAMLIdentifier}.
...
This brings several advantages. First, the IdP authenticates users by any appropriate means (e.g., password,
...
We summarize prior privacy-preserving solutions for SSO and also identity federation in Table \ref{tbl:comparison-protocol}.
...
without holding any permanent secret verified by the RP or by himself maintaining an account at the RP.
...
Privacy-preserving identity federation \cite{ELPASSO,UnlimitID,hyperledge-idemix,PseudoID,Opaak,uprov}
