...
\noindent \textbf{Non-anonymous User Identity.}
...
\noindent \textbf{Independency of User Authentication.}
...
Thus, if a credential was lost or compromised,
...
\noindent \textbf{User Attributes Maintained at the IdP.}
...
Besides, before enclosing attributes in an identity token for any RP,
...
\footnotesize
  ...
  & Non-anonymous & Independency of & User Attributes & IdP-based & RP-based & Collusive Attack \\
  & User Identity & User Authentication &  Maintained at the IdP & Login Tracing & Identity Linkage & by the IdP and RPs \\\hline
  PPID-enhanced OIDC & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\Circle$ & $\CIRCLE$ & $\Circle$ \\ \hline
  SPRESSO \\ \hline
  BrowserID \\ \hline
  EL PASSO \\ \hline
  PseudoID \\ \hline
