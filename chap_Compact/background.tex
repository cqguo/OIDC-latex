...
Therefore, if a credential was lost or compromised,
    the user only needs renew it at the IdP;
        however, if a user needs to prove something to the RP (i.e., some authentication steps are involved),
                the user has to notify each RP if this secret was leaked.
