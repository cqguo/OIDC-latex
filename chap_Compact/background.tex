...
The authentication between a user and an IdP is usually conducted \emph{independently}
    in the specifications of widely-used SSO protocols \cite{OpenIDConnect,rfc6749,SAML},
...
Opaak \cite{Opaak} designs IdP-signed anonymous credentials %in mobile phones
 as pseudonym tokens,
