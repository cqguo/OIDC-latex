...
5. In the original design of Idemix \cite{idemix}, every user logins to an RP as a non-anonymous account.\\
...
Privacy-preserving SSO \cite{BrowserID,SPRESSO,NIST2017draft} and UPPRESSO
            keep the convenience for users,
...
Privacy-preserving identity federation solutions \cite{ELPASSO,UnlimitID,hyperledge-idemix,PseudoID,Opaak}
    protect user privacy against even collusive attacks by the IdP and RPs,
    at the expense of user burdens to (\emph{a}) hold long-term secrets
