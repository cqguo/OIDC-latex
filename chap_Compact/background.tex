...
\noindent \textbf{User-Authorized Attribute Provision.}
...
\begin{table*}[htb]
\footnotesize
    \caption{Comparison of Existing Privacy-Preserving SSO Solution and Federated Identity Management.}
    \centering
    \begin{tabular}{|c|c|c|c|c|c|c|}
  \hline
  \multirow{3}*{\textbf{~~Solution~~}} &
  \multicolumn{3}{c|}{\textbf{SSO Feature} - supported $\CIRCLE$, or not $\Circle$ $\LEFTcircle$} & \multicolumn{3}{c|}{\textbf{Privacy Threat} - prevented $\CIRCLE$, or not $\Circle$} \\ \cline{2-7}
  & User Identity & User Authentication & User-Authorized  & IdP-based & RP-based & Collusive Attack \\
  & at an RP & Only to the IdP &  Attribute Provision & Login Tracing & Identity Linkage & by the IdP and RPs \\\hline
  PPID-enhanced OIDC & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\Circle$ & $\CIRCLE$ & - \\ \hline
  BrowserID & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$? & $\CIRCLE$ & $\Circle$ & - \\ \hline
  PRIMA & $\CIRCLE$ & $\Circle$ & $\CIRCLE$ & $\CIRCLE$ & $\Circle$ & - \\ \hline
  SPRESSO & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\Circle$ & - \\ \hline
  PseudoID & $\CIRCLE$ & $\Circle$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ \\ \hline
  EL PASSO & $\CIRCLE$ & $\Circle$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ \\ \hline
  Opaak & $\CIRCLE$ & $\Circle$ & $\Circle$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ \\ \hline
  Idemix & $\CIRCLE$ & $\Circle$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ \\ \hline
  U-Prove & $\CIRCLE$ & $\Circle$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ \\ \hline
...
\subsection{Existing Privacy-Preserving SSO Solution and Federated Identity Management}
...
BrowserID \cite{BrowserID} are proposed to defend SSO services against the IdP-based login tracing,
...
and two kinds of privacy threats are prevented 


SPRESSO \cite{SPRESSO} is proposed to defend SSO services against the IdP-based login tracing,
...
These RP-verified credentials protect user privacy well %and enable the visits to multiple RPs,
        and two kinds of privacy threats are prevented  \cite{ZhangKSZR21,IsaakidisHD16},
...
In EL PASSO, UnlimitID and PseudoID \cite{ZhangKSZR21,IsaakidisHD16,PseudoID}
...
NEXTLEAP \cite{nextleap} adopts UnlimitID.
...
Table \ref{tbl:comparison-protocol} summaries these privacy-preserving SSO solutions.
