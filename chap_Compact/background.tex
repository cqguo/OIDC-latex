...
Meanwhile, many email and social network providers (such as Google, Facebook, Twitter, etc.) are serving the IdP roles. %social identity providers to support social login.

%As an extension of OAuth 2.0 for user authentication,
OpenID Connect (OIDC) is one of the most popular SSO protocols~\cite{OpenIDConnect}. %As other SSO protocols~\cite{SAMLIdentifier}, OIDC
