...
However, PPID-based approaches cannot prevent the IdP-based login tracing,
 since in the generation of identify tokens the IdP still needs to know which RP the user visits.
...
Similarly, the collusive RPs could link a user's multiple logins based on his user identity in these tokens.
