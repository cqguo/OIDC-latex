...
The RP recognizes each user, as an identity or account \emph{unique}  at the RP,
...
While providing these features, existing privacy-preserving SSO approaches \cite{BrowserID,SPRESSO,NIST2017draft} prevent either the IdP-based login tracing or the RP-based identity linkage, and UPPRESSO prevents both of them.
