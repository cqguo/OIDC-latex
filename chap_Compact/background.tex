...
We discuss existing privacy-preserving identity management solutions and also other related works.
...
The PRIMA IdP signs an authentication credential binding a verification key and a set of user attributes \cite{prima}, and the key is viewed as the user's identity.
