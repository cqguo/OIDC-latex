...
\begin{table*}[htb]
\footnotesize
    \caption{Comparison of Existing Privacy-Preserving Solutions of SSO and Federated Identity Management.}
    \centering
    \begin{tabular}{|c|c|c|c|c|c|c|}
  \hline
  \multirow{3}*{\textbf{~~Solution~~}} &
  \multicolumn{3}{c|}{\textbf{SSO Feature} - supported $\CIRCLE$, not $\Circle$, or partially $\LEFTcircle$} & \multicolumn{3}{c|}{\textbf{Privacy Threat} - prevented $\CIRCLE$, or not $\Circle$} \\ \cline{2-7}
  ...
  BrowserID & $\CIRCLE$ & $\LEFTcircle$ & $\Circle$ & $\CIRCLE$ & $\Circle$ & - \\ \hline
  ...
  U-Prove & $\CIRCLE$ & $\Circle$ & $\LEFTcircle$ & $\CIRCLE$ & $\CIRCLE$ & $\CIRCLE$ \\ \hline
...
Some identity federation solutions \cite{ZhangKSZR21,IsaakidisHD16,} protect user privacy against collusive attacks by the IdP and RPs,
