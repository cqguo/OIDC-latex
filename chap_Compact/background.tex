...
\oldc
Anonymous identity federation systems have been formalized \cite{WangWS13} and solutions \cite{WangWS13, HanCSTW18, HanCSTWW20} were proposed using different cryptographic primitives such as group signature and zero-knowledge proof. Special features such as designated verification \cite{HanCSTW18} and proxy re-verification \cite{HanCSTWW20} are also designed in these schemes.
