...
The experimental evaluation of the UPPRESSO prototype demonstrates
 that it provides efficient SSO services, where a login instance takes only 421 ms and 174 ms on average for internet environment and VPC environment respectively.
 %\textcolor[rgb]{1,0,0}{where a login instance takes only 310 ms on average}.
