...
After modelling UPPRESSO by the Dolev-Yao style model,
...
The trace of identity tokens also confirm no adversary retrieves the token.

Finally,
    we formally prove that,
\emph{user identification}, \emph{RP designation}, \emph{confidentiality}, and \emph{integrity} are satisfied in UPPRESSO.
