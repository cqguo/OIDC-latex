...
\label{sec:analysis}
In this section, we analyze the security and privacy guarantees provided by \usso~and show that it achieves all four required security properties listed in Section~\ref{subsec:basicrequirements} and prevents both types of privacy threats against SSO services.
