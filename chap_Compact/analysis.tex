...
\vspace{1mm}
Finally, we also formally analyze the security properties of UPPRESSO,
...
The Dolev-Yao style model abstracts the entities in a web system,
    ...
    as atomic processes, which communicate with each other through events.
...
%
\textcolor[rgb]{1.00,0.00,0.00}{The UPPRESSO system contains an IdP process,
...
It also contains two honest script processes,
        downloaded from an RP process and the IdP process, respectively.}
