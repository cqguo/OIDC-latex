...
According to the above construction, % of $\mathfrak{L}$, $L'$ and $\mathbb{L}''$, 
 ...
 and $z/y$ is embedded as $ID_{U''_d}$ in $\mathbb{L}''$ for $ID_{RP} = [y]G$ together with $\{u''_1, u''_2, \cdots, u''_{d-1}, u''_{d+1}, \cdots, u''_w\}$.
Meanwhile, $[r_{j'}]G$ and $[y]G$ are two RP identities in $\mathfrak{L}$,
    and $x$ is not in $\{u''_1, u''_2, \cdots, u''_{d-1}, u''_{d+1}, \cdots, u''_w\}$.
So the adversary outputs $s=1$ only it decides $x = z/y$.
