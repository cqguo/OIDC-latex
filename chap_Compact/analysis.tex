...
after receiving $\mathfrak{L}$ and $L'$ from a challenger,
    an adversary outputs the result $s = 1$ if it determines that $u' \in \{u_1, u_2, \cdots, u_v\}$,
        ...
        We define the adversary's advantage in this game as ${\rm Adv}_A$.
...
&{\rm Pr}_2={\rm Pr}\{\mathcal{D'^*}(G, [x]G, [y]G, [z]G)=1\}\\ =&{\rm Pr}'_2 =  {\rm Pr}\{\mathcal{G}_r(\mathfrak{L}, L'|ID_{U'} \in \mathbb{Z}_n)=1\}\\
