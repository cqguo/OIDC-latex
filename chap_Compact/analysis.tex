...
This negligible probability means the identity token identifies \emph{only} the target RP.
...
If the adversary is able to find $t$ and $t'$
    ...
    he will have non-negligible advantages in $\mathcal{G}_c$
...
becomes negligible with the increasing security parameter $k$.
