...
We assume there have already been $a$ users' visits to $b$ RPs, denoted as $L=$\{($ID_{RP_1}$, $t_1$, $[ID_{U_1}]{ID_{RP_1}}$), ($ID_{RP_2}$, $t_2$, $[ID_{U_1}]{ID_{RP_2}}$), $\cdots$, ($ID_{RP_b}$, $t_{a, b}$, $[ID_{U_a}]{ID_{RP_b}}$)\}. 
...
On receiving the input, the challenger of $\mathcal{G'}$ randomly chooses $u_1, u_2, \cdots, u_a$, $r_1, r_2, \cdots, r_b$ and $t_1, t_2, \cdots, t_{a, b}, t'$ from $(1,n)$. 
