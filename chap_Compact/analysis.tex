...
\vspace{1mm}
\noindent{\textsc{Theorem 4. (Identity Token Confidentiality)}} {\em An identity token $T$ whose $PID_{RP}$ designates an RP with $ID_{RP}$ can only be accessed by that RP, besides the requesting user and the issuing IdP.}
