...
\begin{figure}[tb]
  ...
  \caption{The PPT algorithm the $PID_{RP}$ collision, to solve the ECDLP.}  
...
\begin{figure}[tb]
  ...
  \caption{The PPT algorithm based on the RP-based identity linkage, to solve the ECDDH problem.}
