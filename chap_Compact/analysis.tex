...
\subsection{Security}
UPPRESSO satisfies the security requirements of identity tokens in SSO services,
     as discussed in Section \ref{subsec:basicrequirements}.
\vspace{-\topsep}
\begin{itemize}
\setlength{\topsep}{0pt}
...
This definitely violates the ECDLP.
...
\vspace{1mm}
Finally, we formally analyze the security properties of UPPRESSO, %especially confidentiality and integrity,
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.995\linewidth]{fig/dalgorithm.pdf}
