...
We assume there have already been $a$ users' visits to $b$ RPs, denoted as $L=$\{($ID_{RP_1}$, $t_{1, 1}$, $[ID_{U_1}]{ID_{RP_1}}$), ($ID_{RP_2}$, $t_{1, 2}$, $[ID_{U_1}]{ID_{RP_2}}$), $\cdots$, ($ID_{RP_b}$, $t_{a, b}$, $[ID_{U_a}]{ID_{RP_b}}$)\}.
...
That is, $L=$\{($ID_{RP_1}$, $t_{1, 1}$, $[ID_{U_1}]{ID_{RP_1}}$), ($ID_{RP_2}$, $t_{1, 2}$, $[ID_{U_1}]{ID_{RP_2}}$), $\cdots$, ($ID_{RP_b}$, $t_{a, b}$, $[ID_{U_a}]{ID_{RP_b}}$)\}$=$\{($[r_1]G$, $t_{1, 1}$, $[[u_1][r_1]G$), ($[r_2]G$, $t_{1, 2}$, $[u_1][r_2]G$), $\cdots$, ($[r_b]G$, $t_{a, b}$, $[u_a][r_b]G$)\}.
Then challenger randomly chooses $\alpha$ in $(1, a)$ and $\beta$ in $(1, b)$, and replaces $[u_{\alpha}][r_{\beta}]G$ with $[r_{\beta}]Q_1$.
Thus, there is $L=$\{($[r_1]G$, $t_{1, 1}$, $[[u_1][r_1]G$), ($[r_2]G$, $t_{1, 2}$, $[u_1][r_2]G$), $\cdots$, ($[r_{\beta}]G$, $t_{\alpha, \beta}$, $[r_{\beta}]Q_1$), $\cdots$, ($[r_b]G$, $t_{a, b}$, $[u_a][r_b]G$)\}
And, let $l=$($ID_{RP_{b+1}}$, $t'$, $[ID_U']ID_{RP_{b+1}}$)$=$($Q_2$, $t'$, $Q_3$).
