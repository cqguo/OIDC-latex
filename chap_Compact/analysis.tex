...
\noindent\textcolor{blue}{\textbf{RP Designation:} {\em $PID_{RP}$ in any identity tokens identifies one and only one RP with $ID_{RP} = [r]G$, from all the registered RPs.}
}

\noindent\textbf{Proof.}
\textcolor{blue}{Using the Dolev-Yao-style model, $PID_{RP} = [t]ID_{RP}$
