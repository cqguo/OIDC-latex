...
\begin{figure}[tb]
  ...
  \caption{The algorithm based on the RP-based identity linkage.}
...
Equation \ref{eq:game-succed} is equal to $Pr_c$
 ...
 while Equation \ref{eq:game-fail} is $Pr_{\bar{c}}$ for it represents the incorrect case of $ID_{U} =y$ but $ID_{U'} = z/x$.
