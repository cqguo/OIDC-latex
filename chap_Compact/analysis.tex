...
We also formally analyze the security properties of UPPRESSO,
     based on the Dolev-Yao style model \cite{SPRESSO},
...
It also defines {\em script processes} to model client-side scripts, i.e.,  JavaScript code,
...
The details on the Dolev-Yao style model and the security proof of UPPRESSO are in the appendix.
