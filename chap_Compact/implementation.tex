...
We have implemented the UPPRESSO prototype system,\footnote{The prototype is open-sourced at https://github.com/uppresso/.}
 and experimentally evaluated its performance
...
The calculations of $ID_{RP}$ and $PID_U$ are implemented based on built-in Java cryptographic libraries. %(e.g., BigInteger).
