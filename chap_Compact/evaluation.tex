...
The overall times of SSO login are  113 ms, 308 ms, and 310 ms for MITREid Connect, SPRESSO, and UPPRESSO, respectively.
In the preparation and requesting, UPPRESSO requires 271 ms in total.
...
SPRESSO needs 19 ms for an RP to obtain the IdP's publicly accessible information,
    e.g., public key (SPRESSO allows a user to assign any IdPs before login without initial registrations)
