...
In the latter scenario, all entities are deployed in the same virtual private cloud and connected to each other in one vSwitch,
...
or
 (\emph{b})
312 ms, 421 ms, and 510 ms, respectively, when the user browser runs locally to remotely visit the IdP and RP.
...
Compared with MITREid Connect, the main overhead of UPPRESSO is to open a new browser window and download the scripts.
