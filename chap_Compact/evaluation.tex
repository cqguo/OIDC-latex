...
\noindent {\bf Experiment setup.} We compared UPPRESSO with MITREid Connect and SPRESSO.
...
In contrast, \usso~incurs an extra overhead\footnote{This overhead may be reduced %by silently conducting these operations when the user visits the RP website, or
