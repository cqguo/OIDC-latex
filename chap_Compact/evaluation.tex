...
MITREid Connect requires the IdP to send the identity token to the RP's web page which then sends the token to the RP server through a JavaScript function, and needs 71 ms.
