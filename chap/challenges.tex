...
{\color{red} The root conflicts between secure authentication and privacy are caused the binding requirements of SSO systems. The bindings required by secure authentication includes: 
\begin{itemize}
