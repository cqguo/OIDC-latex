...
\noindent\textbf{RP dynamic registration.} OIDC provides a dynamic registration mechanism~\cite{DynamicRegistration} for the RP to renew its RPID dynamically. % shown in Figure~\ref{fig:OpenID}.
...
Discrete logarithm problem is adopted in UPRESSO. 
