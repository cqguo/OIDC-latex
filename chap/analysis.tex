...
Recluse only makes the following mechanisms provided in OIDC not included in Recluse. However, Recluse still provides the solutions to ensure the confidentiality and binding. 
...
\end{itemize}
 ...
 We further divide these three solutions into 5 goals to be achieved in the design in Recluse:
\begin{itemize}
