...
\item Abduction attack: Honest user logs in to the honest RP under adversaries' identity. 
\end{itemize}
...
\begin{itemize}
\item \textbf{Curious IdP} acts an as completely honest IdP.
