...
However, SSO introduces privacy threats,
    as ({\em a}) the curious IdP could potentially track a user's visits to various RPs,
...
%%%% for different users, the accounts may be the same.
 colluding RPs cannot link a user's identities across RPs.
We have built a prototype of UPPRESSO on top of MITREid Connect, an open-source SSO system.
