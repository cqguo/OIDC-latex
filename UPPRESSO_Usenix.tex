...
\hyphenation{target-Origin op-tical net-works semi-conduc-tor}
...
\maketitle
\begin{abstract}
Single sign-on (SSO) allows a user to maintain only the credential at the identity provider (IdP), to login to numerous RPs.
...
This paper proposes a privacy-preserving SSO system, called \emph{UPPRESSO},
 to protect a user's online profile against both the curious IdP and collusive RPs.
