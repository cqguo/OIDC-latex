...
This paper presents a privacy-preserving SSO protocol, called \usso, to protect users' online profiles against either (\emph{a}) an honest-but-curious IdP or (\emph{b}) malicious RPs and users who could collude.
